...
const Auth = () => {
  ...
  const handleSubmit= (e) =>{
    //without preventDefault() the url will &email=&password=
    e.preventDefault();
    if(!email && !password){
        ...
        { !isSignup && <img src={icon} alt='stack overflow' className='login-logo'/>}
          <form onSubmit={handleSubmit}>
            ...
            <label htmlFor="password">
              ...
              { isSignup && <p style={{color:"#666767"}}>Password must contain at least eight<br/> characters, including at least 1 letter and 1 <br/> number.</p>}
            </label>
            {
              isSignup && (
                <label htmlFor='check'>
