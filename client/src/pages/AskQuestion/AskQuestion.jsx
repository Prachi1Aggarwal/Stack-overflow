...
const AskQuestion = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    // console.log({ questionTitle, questionBody, questionTags, userPosted: User.result.name , navigate})
            ...
            <form onSubmit={handleSubmit}>
                <div className='ask-form-container'>
                    ...
                    <label htmlFor='ask-ques-body'>
                        ...
                        <textarea name='' id='ask-ques-body' onChange={(e)=>{setQuestionBody(e.target.value)}} rows='10' cols='30' onKeyDown={ handleEnter }></textarea>
                    </label>
